...
/** Захисний ліміт сирої вибірки подій для дашборда (захист від DoS/OOM) */
const ANALYTICS_MAX_ROWS = 20_000;
...
export default async function AnalyticsPage({
  ...
  const [
    ...
    db.analyticsEvent.findMany({
      ...
      // Захист від DoS/OOM: беремо лише останні N подій періоду. При виборі
      // «Весь час» повна вибірка могла б витягнути сотні тисяч рядків у RAM.
