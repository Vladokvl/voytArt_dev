const TopBarClassicSvg = ({
  ...
  return (
    ...
    >
      ...
      <path className="fill-gray-100 dark:fill-gray-950" d="M0 0h500v500H0z" />
      ...
      <path
        ...
        mask="url(#a)"
      />
      <circle cx={47} cy={39} r={17} className="fill-gray-200 dark:fill-gray-600" />
      <rect width={88} height={33} x={94} y={22.5} className="fill-primary-subtle" rx={6} />
      <rect width={69} height={13} x={103.5} y={32.5} className="fill-primary" rx={6} />
      <rect
        width={56}
        height={13}
        x={192}
