const FileFigma = ({ height = 100, width = 100 }: { height?: number; width?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 287.82 384" width={width} height={height}>
      <path
        fill="#2b2b32"
      ...
      ></path>
      <path fill="#4c4c54" d="M178.39 0L287.82 114.16 179.42 114.16 178.39 0z"></path>
      <path
        fill="#1abcfe"
        fillRule="evenodd"
