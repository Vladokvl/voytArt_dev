  ...
  return (
    ...
    >
      ...
      <path
        ...
        mask="url(#a)"
      />
      <circle cx={47.5} cy={47.5} r={27.5} className="fill-gray-200 dark:fill-gray-600" />
      <rect width={152} height={33} x={20} y={105} className="fill-primary-subtle" rx={6} />
      <rect width={69} height={13} x={26} y={115} className="fill-primary" rx={6} />
      <rect
        width={125}
        height={13}
        x={20}
      ...
      <rect
        ...
        rx={6}
      />
      <path className="fill-gray-100 dark:fill-gray-950" d="M192 0h308v500H192z" />
