const StackedSideSvg = ({
  ...
  return (
    <svg
      ...
      fill="none"
    >
      <rect width={500} height={500} className="fill-white dark:fill-gray-800 " rx={20} />
      ...
      <path
        ...
        mask="url(#a)"
      />
      <circle cx={32} cy={37} r={17} className="fill-gray-200 dark:fill-gray-600" />
      <rect width={34} height={33} x={15} y={84} className="fill-primary-subtle" rx={6} />
      <rect width={13} height={13} x={25.5} y={94} className="fill-primary" rx={6} />
      <rect
        width={17}
        height={17}
        x={23.5}
      ...
      <path className="fill-gray-200 dark:fill-gray-600" d="M211 0v500h4V0h-4Z" mask="url(#b)" />
      <rect width={119} height={33} x={79} y={20} className="fill-primary-subtle" rx={6} />
      <rect width={69} height={13} x={85} y={30} className="fill-primary" rx={6} />
      <rect
        width={119}
        height={13}
        x={79}
      ...
      <rect
        ...
        rx={6}
      />
      <path className="fill-gray-100 dark:fill-gray-950" d="M213 0h287v500H213z" />
