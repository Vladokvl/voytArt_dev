    ...
    extend: {
      colors: {
        primary: {
          ...
          500: 'color-mix(in srgb, var(--primary) 50%, white)',
          600: 'color-mix(in srgb, var(--primary) 60%, black)',
          700: 'color-mix(in srgb, var(--primary) 70%, black)',
          800: 'color-mix(in srgb, var(--primary) 80%, black)',
          900: 'color-mix(in srgb, var(--primary) 90%, black)',
          950: 'color-mix(in srgb, var(--primary) 95%, black)',
          DEFAULT: 'var(--primary)',
