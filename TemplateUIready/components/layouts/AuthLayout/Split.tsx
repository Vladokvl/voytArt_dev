...
const Split = ({ children, content, tagline = '', description = '', ...rest }: SplitProps) => {
  return (
      ...
      <div className="bg-no-repeat bg-cover py-6 px-16 flex-col justify-center items-center hidden lg:flex bg-primary rounded-3xl">
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="text-center max-w-[550px]">
            <h1 className="text-neutral">{tagline}</h1>
            <p className="text-neutral opacity-80 mx-auto mt-8 font-semibold">{description}</p>
          </div>
        </div>
      </div>
      <div className="flex flex-col justify-center items-center ">
        <div className="w-full xl:max-w-[600px] px-8 max-w-[500px]">
