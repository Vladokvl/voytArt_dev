  ...
  return (
    <div
      className={classNames(
        'rich-text-editor rounded-xl ring-2 border-2 pt-3 transition-all duration-200',
        editor.isFocused
          ? 'ring-primary border-primary bg-white dark:bg-gray-800 shadow-[0_0_0_3px_var(--primary-subtle)]'
          : 'ring-gray-200 dark:ring-gray-600 border-gray-200 dark:border-gray-600 bg-gray-100 dark:bg-gray-700',
        invalid && 'bg-error-subtle',
        editor.isFocused && invalid && 'ring-error border-error'
      )}
    >
      ...
      <EditorContent
        ref={ref}
        className={classNames(
          'max-h-[600px] overflow-auto px-2 prose prose-p:text-sm dark:prose-invert max-w-full',
          editorContentClass
        )}
        editor={editor}
        {...rest}
