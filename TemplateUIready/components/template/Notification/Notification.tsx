...
import { apiGetNotificationList, apiGetNotificationCount } from '@/services/common/CommonService'
          ...
          <div className={classNames('flex items-center justify-center', notificationHeight)}>
            <div className="text-center">
              <img
                ...
                alt="no-notification"
              />
              <h6 className="font-semibold">{t('noNotifications')}</h6>
              <p className="mt-1">{t('pleaseTryAgainLater')}</p>
            </div>
          </div>
        )}
      </ScrollBar>
